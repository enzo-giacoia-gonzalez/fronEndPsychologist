  ...
  return (
    <Grid container padding={28} alignItems="center">
      <Grid item xs display="flex" justifyContent="center" alignItems="center">
        ...
        <Input onChange={(e)=>handleName(e)} value={input.nombre===undefined?responseVideo?.nombre:input.nombre} placeholder="Editar titulo del video" name="name" sx={{ width: '100%', border: 1, borderColor: 'white', marginBottom: "15px", borderRadius: "4px", marginRight: '5px' }} type='text'></Input>
